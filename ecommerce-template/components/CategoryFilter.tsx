...
const defaultAvailableOptions = {
  ...
  genderCategories: ["Mujer", "Hombre", "Niños", "Unisex"],
...
export default function CategoryFilter({
  ...
  const [filters, setFilters] = useState<FilterOptions>({
    ...
    genderCategories: initialFilters.genderCategories || [],
  ...
  const activeFiltersCount = 
    ...
    filters.genderCategories.length +
    ...
    >
      <Card className="sticky top-20 overflow-hidden">
        ...
        <CardContent className="space-y-6">
          ...
          >
            <Collapsible 
              open={isOpen.genderCategories} 
              onOpenChange={(open) => setIsOpen(prev => ({ ...prev, genderCategories: open }))}
            >
              <CollapsibleTrigger asChild>
                ...
                >
                  <Button variant="ghost" className="w-full justify-between p-0 h-auto">
                    <span>Género</span>
                    <motion.span 
                      animate={{ rotate: isOpen.genderCategories ? 0 : 90 }}
              ...
              <CollapsibleContent className="space-y-2 mt-3">
                <motion.div
                  ...
                  className="space-y-2"
                >
                  {availableOptions.genderCategories.map((genderCategory, index) => (
                    <motion.div 
                      key={genderCategory} 
                    ...
                    >
                      <Checkbox
                        id={`gender-${genderCategory}`}
                        checked={filters.genderCategories.includes(genderCategory)}
                        onCheckedChange={() => toggleArrayFilter('genderCategories', genderCategory)}
                      />
                      <motion.label 
                        htmlFor={`gender-${genderCategory}`} 
