            ...
            {isAuthenticated ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="glass">
                  ...
                  <DropdownMenuItem onClick={() => onNavigate?.('profile')}>Mi Perfil</DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onNavigate?.('orders')}>Mis Pedidos</DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onNavigate?.('favorites')}>Favoritos</DropdownMenuItem>
