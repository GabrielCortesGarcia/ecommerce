...
export const mockProducts: Product[] = [
  ...
  {
    id: "13",
    name: "Camiseta Estampada Dinosaurios",
    price: 19.99,
    ...
    sizes: ["2-3 años", "4-5 años", "6-7 años", "8-9 años", "10-11 años"],
    isNew: true,
    isOnSale: false
  },
  {
