...
export default function AdminPanel({ onAddProduct, onUpdateProduct, onDeleteProduct }: AdminPanelProps) {
  ...
  const handleSubmitProduct = (e: React.FormEvent) => {
    ...
    const newProduct: Omit<Product, 'id'> = {
      ...
      genderCategory: productForm.genderCategory,
                    ...
                    <TableBody>
                      {filteredProducts.map((product) => (
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge variant="outline">{product.genderCategory || "No asignado"}</Badge>
                          </TableCell>
                          <TableCell>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto glass">
            ...
            <form onSubmit={handleSubmitProduct} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="genderCategory">Género</Label>
                  <Select 
                    value={productForm.genderCategory} 
                    onValueChange={(value) => setProductForm(prev => ({ ...prev, genderCategory: value }))}
                  >
                    <SelectTrigger>
